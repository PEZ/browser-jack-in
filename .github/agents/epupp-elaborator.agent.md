---
description: 'Transforms loose prompts into structured, context-rich prompts with file refs and verification steps. Invoke before coding when the user prompt is hasty or underspecified.'

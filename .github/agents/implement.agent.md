---
description: 'Executes feature plans via TDD: failing test, implement, verify, refactor. Invoke when a plan exists and needs systematic execution with test gates.'
name: Implementer

---
description: 'Writes Playwright E2E tests in Docker following project polling/assertion patterns. Invoke for all E2E test creation or modification - never write E2E tests directly.'
